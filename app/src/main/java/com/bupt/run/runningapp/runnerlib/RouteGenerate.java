package com.bupt.run.runningapp.runnerlib;
...
import com.bupt.run.runningapp.RouteSelectActivity;
...
//        distance = LengthBalance.lengthBalance(distance);
    ...
    public static void passingPointRouteWithMerchant(final LatLng startPoint, final LatLng passingPoint, double distance, int orient, final RouteSelectActivity activity){
